...
public final class SubscriptionConfig {
    ...
    public static List<Subscription> getSubscriptions() {
        Object v = Hawk.get(HawkConfig.SUBSCRIPTIONS, new ArrayList<Subscription>());
        return v instanceof List ? (List<Subscription>) v : new ArrayList<>();
    }

    public static void setSubscriptions(List<Subscription> subs) {
        Hawk.put(HawkConfig.SUBSCRIPTIONS, subs == null ? new ArrayList<>() : subs);
    }
    ...
    public static List<String> getSearchHistory() {
        Object v = Hawk.get(HawkConfig.HISTORY_SEARCH, new ArrayList<String>());
        return v instanceof List ? (List<String>) v : new ArrayList<>();
    }

    public static void setSearchHistory(List<String> history) {
        Hawk.put(HawkConfig.HISTORY_SEARCH, history == null ? new ArrayList<>() : history);
    }

    public static void clearSearchHistory() {
        Hawk.put(HawkConfig.HISTORY_SEARCH, new ArrayList<String>());
    }
    ...
    public static HashMap<String, HashMap<String, String>> getCheckedSources() {
        Object v = Hawk.get(HawkConfig.SOURCES_FOR_SEARCH, new HashMap<String, HashMap<String, String>>());
    ...
    public static void setCheckedSources(HashMap<String, HashMap<String, String>> sources) {
        Hawk.put(HawkConfig.SOURCES_FOR_SEARCH, sources == null ? new HashMap<>() : sources);
    }
    ...
    public static String getLastImportDir() {
        return Hawk.get("before_selected_path", "");
    }

    public static void setLastImportDir(String dir) {
        Hawk.put("before_selected_path", dir == null ? "" : dir);
    }
}
